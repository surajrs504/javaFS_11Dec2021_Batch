...
public class UsersService {
	...
	public UserInfoModel findByFirstnameAndPassword(String username, String password) {

		UserInfoModel userInfoModel = userDao.findByFirstnameAndPassword(username, password);
	...
	public List<UserInfoModel> getUserDataService() {
		 ...
		 List<UserInfoModel> usersList= (List)userDao.findByrollid(2);
	...
	public  UserInfoModel  isCorrectPassword_or_NotService(String password) {
		  ...
		  UserInfoModel  usersList=  userDao.findByPassword(password);
